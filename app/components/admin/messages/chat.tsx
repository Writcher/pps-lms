...
import { chatFormData, chatMenuProps, deleteMessageData, fetchChatUsersData, fetchMessagesData, newMessageQuery, readMessagesData } from "@/app/lib/dtos/message";
...
import Gray800Tooltip from "../projects/utils";
        ...
        <main className="flex flex-col h-screen w-full">
            ...
            {scholars.map(scholarcontent => (
                tabValue === scholarcontent.id && (
                    <div key={scholarcontent.id} className="flex h-[90%] w-full">
