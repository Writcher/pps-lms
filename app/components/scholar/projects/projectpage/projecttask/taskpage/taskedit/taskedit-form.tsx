            ...
            {taskDataLoading ? (
                ...
                <div className='flex flex-col flex-grow w-full h-full gap-4 py-2 pr-2 overflow-y-auto custom-scrollbar'>
                    ...
                    <div className='flex w-full'>
                        <TextField
                            id="taskstatus_id"
                            label={errors.taskstatus_id ? errors.taskstatus_id.message : selectDataLoading ? "Cargando Tipos" : "Tipo de Proyecto"}
                            type="text"
                            variant="outlined"
                            color="warning"
                            select
                                ...
                                <DatePicker
                                    ...
                                    slotProps={{
                                        textField: {
                                            ...
                                            color: "warning",
                                            InputProps: {
                                                style: { userSelect: "none", pointerEvents: "none" }, // Evita selección y desactiva eventos de puntero
                                            }
                                        }
                                    }}
                                />
